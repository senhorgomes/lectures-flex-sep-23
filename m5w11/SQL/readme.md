...
SELECT album_name, song_name, artist_name
FROM albums
INNER JOIN songs
...
I want to see how many songs have a rating of 1
...
9. Enhance previous query to only include albums that have more than 13 songs (requires HAVING)
