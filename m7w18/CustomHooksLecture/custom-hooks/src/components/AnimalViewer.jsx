...
function AnimalViewer() {
    ...
    return ( 
        // We need to add a new button that changes the index
        // Once the count number increase, it will change the animal that is being displayed
        <>
            <h1>{mockData[count].animal}</h1>
            <h3>{mockData[count].description}</h3>
            <img src={mockData[count].image}/>
            <div>
